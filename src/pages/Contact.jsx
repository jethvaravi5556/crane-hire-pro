          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="h-full text-center border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white/80 backdrop-blur-sm rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-lg p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Find Our Location</h3>
